window.SANKOFA_ACHIEVEMENTS = [
  ...
  { id: "explorer", name: "Descobridor de Origens", desc: "Complete o Mundo 1", icon: "☀", c: function (s) { return s.solved.filter(function (e) { return e.indexOf("w1") === 0; }).length >= 15; } },
  ...
  { id: "collector", name: "Colecionador", desc: "Recolha todos os 15 fragmentos do Mundo 1", icon: "◆", c: function (s) { return s.solved.filter(function (e) { return e.indexOf("w1") === 0; }).length >= 15; } },
