window.SANKOFA_ENIGMAS = [
  ...
  },
  {
    id: "w1e2",
    world: 1,
    title: "O Deserto que Foi Jardim",
    ...
    hints: [
      ...
      "Fica no norte de África, entre o Atlântico e o Mar Vermelho.",
      "As suas pinturas mostram hipopótamos e nadadores."
    ],
    fragment: { pattern: "fp-saara", name: "Saara Verde" },
    curiosity: "O próximo \"Saara Verde\" deverá ocorrer daqui a cerca de 10.000 anos, quando o eixo da Terra inclinar novamente.",
    source: "HGA UNESCO, Volume I"
  },
  {
    id: "w1e3",
    world: 1,
    title: "Os Tecelões do Fogo",
    ...
    hints: [
      ...
      "Quando enferruja, fica vermelho-alaranjado.",
      "Sem este metal, a agricultura moderna seria impossível."
    ],
    fragment: { pattern: "fp-ferro", name: "Ferro" },
    curiosity: "Os fornos africanos atingiam temperaturas de 1.200°C — mais altas que muitos fornos europeus da mesma época.",
    source: "HGA UNESCO, Volume I"
  },
  {
    id: "w1e4",
    ...
    hints: [
      ...
      "As suas línguas incluem quicongo, quimbundo e zulu.",
      "A expansão começou entre a Nigéria e os Camarões."
    ],
    fragment: { pattern: "fp-bantu", name: "Bantu" },
    curiosity: "O português do Brasil tem centenas de palavras Bantu: samba, moleque, caçula, banguela, dendê, berimbau, quitute.",
    source: "HGA UNESCO, Volume I"
  },
  {
    id: "w1e5",
    world: 1,
    title: "A Arte nas Pedras",
    ...
    hints: [
      ...
      "O nome do planalto significa \"rio dos rios\" em tuaregue.",
      "É Património Mundial da UNESCO desde 1982."
    ],
    fragment: { pattern: "fp-arte", name: "Arte Rupestre" },
    curiosity: "Uma das pinturas mostra um \"Grande Deus\" com olhos enormes — provavelmente um xamã com máscara cerimonial.",
    source: "HGA UNESCO, Volume I"
  },
  {
    id: "w1e6",
  ...
  },
  {
    ...
    hints: [
      ...
      "Acontecia todos os anos, renovando a terra negra.",
      "Sem isto, não haveria agricultura no deserto."
    ],
    fragment: { pattern: "fp-nilo", name: "Lama do Nilo" },
    curiosity: "A cor preta em Kemet não era associada à morte, mas sim à vida, fertilidade e renascimento, graças a essa lama salvadora.",
    source: "HGA UNESCO, Volume II"
  },
  {
    id: "w2e2",
    world: 2,
    title: "O Vizinho Poderoso",
    ...
    hints: [
      ...
      "O termo egípcio é Ta-Seti.",
      "Robin Hood também usava esta arma."
    ],
    fragment: { pattern: "fp-arco", name: "Arco Núbio" },
    curiosity: "Kerma, a primeira capital de Cuxe, tinha muralhas defensivas e um gigantesco templo de adobe chamado Deffufa Ocidental.",
    source: "HGA UNESCO, Volume II"
  },
  {
    id: "w2e3",
    world: 2,
    title: "Os Faraós Negros",
    ...
    hints: [
      ...
      "É mencionado na Bíblia no livro de 2 Reis.",
      "Ele foi o mais famoso dos Faraós da 25ª Dinastia."
    ],
    fragment: { pattern: "fp-taharqa", name: "Coroa de Taharqa" },
    curiosity: "Taharqa usava uma coroa única com duas cobras (uraei) em vez de uma, simbolizando o seu domínio tanto sobre Cuxe quanto sobre o Egito.",
    source: "HGA UNESCO, Volume II"
  },
  {
    id: "w2e4",
    world: 2,
    title: "A Cidade de Ferro",
    ...
    hints: [
      "Tem a ver com o formato e o ângulo.",
      "Assemelham-se a um triângulo muito mais estreito.",
      "Não são feitas de ouro nem subterrâneas na totalidade."
    ],
    fragment: { pattern: "fp-piramide", name: "Pirâmide Meroítica" },
    curiosity: "O Sudão atual tem mais do dobro do número de pirâmides que o Egito, a grande maioria construída durante o período de Meroé.",
    source: "HGA UNESCO, Volume II"
  },
  {
    id: "w2e5",
    world: 2,
    title: "A Escrita Esquecida",
    ...
    hints: [
      "Funciona mais como o alfabeto que usamos hoje.",
      "Não era um sistema puramente de 'desenhos'.",
      "É sobre como os símbolos representam sons, não conceitos."
    ],
    fragment: { pattern: "fp-escrita", name: "Pedra Meroítica" },
    curiosity: "Existem mais de mil inscrições meroíticas em estelas de pedra, templos e túmulos, muitas das quais esperando serem totalmente decifradas.",
    source: "HGA UNESCO, Volume II"
  },
  {
    id: "w2e6",
    world: 2,
    title: "As Leoas de Cuxe",
    ...
    hints: [
      "É um título que deu origem a um nome feminino comum hoje.",
      "Começa com a letra 'K'.",
      "As escrituras cristãs até mencionam 'A rainha Candace dos etíopes'."
    ],
    fragment: { pattern: "fp-kandake", name: "Joia Kandake" },
    curiosity: "Após expulsar os romanos da região fronteiriça, os soldados de Amanirenas levaram uma cabeça de bronze do Imperador Augusto e enterraram-na nos degraus de um templo em Meroé, para que as pessoas pisassem nela para sempre.",
    source: "HGA UNESCO, Volume II"
  },
  {
    id: "w2e7",
    world: 2,
    title: "O Gigante do Mar Vermelho",
    ...
    hints: [
      ...
      "A resposta inclui o império que construiu a Grande Muralha.",
      "Os três rivais eram os vizinhos de Júlio César, os donos do Irão e a dinastia Han."
    ],
    fragment: { pattern: "fp-axum", name: "Estela de Axum" },
    curiosity: "Uma das estelas de Axum, com 33 metros de altura e pesando mais de 500 toneladas, é um dos maiores blocos únicos de pedra alguma vez tentados a ser erguidos na história humana.",
    source: "HGA UNESCO, Volume II"
  },
  {
    id: "w2e8",
    world: 2,
    title: "Uma Cruz na Moeda de Ouro",
    ...
    hints: [
      "Tem a ver com o surgimento de um novo império religioso no século VII.",
      "Afetou diretamente o controlo das rotas do Mar Vermelho.",
      "Ocorreu muito depois dos Romanos caírem."
    ],
    fragment: { pattern: "fp-cruz", name: "Moeda de Ezana" },
    curiosity: "A Etiópia foi o único reino na região que permaneceu esmagadoramente cristão, isolado nas montanhas, tornando-se o lendário reino de 'Preste João' procurado pelos exploradores europeus.",
    source: "HGA UNESCO, Volume II"
  },

  /* ============================================================
   * MUNDO 3 — IMPÉRIOS DO SAHEL (HGA Vol III-IV, séc. VII-XVI)
   * ============================================================ */
  {
    id: "w3e1",
    world: 3,
    title: "O Imperador do Ouro",
    ...
    hints: [
      ...
      "Sua peregrinação envolveu mais de 60 mil pessoas.",
      "Forbes o classificou como o homem mais rico da história."
    ],
    fragment: { pattern: "fp-mansa", name: "Mansa Musa" },
    curiosity: "Forbes calculou em 2012 que sua fortuna ajustada equivaleria a 400 bilhões de dólares — a maior fortuna individual já registada na história humana.",
    source: "HGA UNESCO, Volume IV"
  },
  {
    id: "w3e2",
    world: 3,
    title: "O Leão de Niani",
    ...
    hints: [
      ...
      "1235 é a data canônica.",
      "Marca o fim do reino de Sosso e o nascimento do Mali."
    ],
    fragment: { pattern: "fp-sundiata", name: "Carta de Manden" },
    curiosity: "A Carta de Manden foi reconhecida pela UNESCO em 2009 como Patrimônio Cultural Imaterial — texto-pacto político 5 séculos antes da Magna Carta inglesa.",
    source: "HGA UNESCO, Volume IV"
  },
  {
    id: "w3e3",
    world: 3,
    title: "A Universidade de Adobe",
    ...
    hints: [
      "Mais de meio milhão.",
      "Mais que toda biblioteca europeia da época.",
      "Hoje Patrimônio Mundial UNESCO."
    ],
    fragment: { pattern: "fp-tombuctu", name: "Tombuctu" },
    curiosity: "Em 2012, em apenas 6 meses, bibliotecários e familiares anônimos esconderam 350 mil manuscritos em barris e poços, salvando-os dos jihadistas. A operação ficou em segredo até a libertação em 2013.",
    source: "HGA UNESCO, Volume IV"
  },
  {
    id: "w3e4",
    world: 3,
    title: "O Sucessor que Reformou",
    ...
    hints: [
      "Tomou o poder em 1493.",
      "Seu nome significa 'usurpador' em songhai — assumido com orgulho.",
      "Fez peregrinação a Meca em 1497."
    ],
    fragment: { pattern: "fp-songhai", name: "Songhai" },
    curiosity: "O Songhai caiu em 1591 quando o sultão marroquino Ahmad al-Mansur enviou um exército atravessando o Saara com armas de fogo — primeira derrota africana causada por tecnologia bélica importada da Europa.",
    source: "HGA UNESCO, Volume IV"
  },
  {
    id: "w3e5",
    world: 3,
    title: "O Sal Vale Ouro",
    intro: "No deserto, o que falta vale mais. Bloco por bloco, grama por grama.",
    ...
    hints: [
      ...
      "Conservava alimentos antes da refrigeração.",
      "É também essencial para o corpo humano."
    ],
    fragment: { pattern: "fp-gana", name: "Sal & Ouro" },
    curiosity: "Em algumas viagens, blocos retangulares de sal trocavam grama-por-grama com ouro em pó. Os camelos carregavam até 100 kg de sal cada um.",
    source: "HGA UNESCO, Volume III"
  },
  {
    id: "w3e6",
    world: 3,
    title: "O Viajante Marroquino",
    ...
    hints: [
      ...
      "Viajou mais que Marco Polo.",
      "Visitou Mali sob Mansa Suleyman."
    ],
    fragment: { pattern: "fp-ibn-battuta", name: "Rihla" },
    curiosity: "Ibn Battuta elogiou a segurança nas rotas malinesas: \"Não há lugar mais seguro no mundo. Nem o viajante nem o local temem ladrões nem violentos.\"",
    source: "HGA UNESCO, Volume IV"
  },
  {
    id: "w3e7",
    world: 3,
    title: "O Sábio de Tombuctu",
    ...
    hints: [
      ...
      "Foi exilado por 14 anos em Marraquexe.",
      "Tem instituto com seu nome em Tombuctu hoje."
    ],
    fragment: { pattern: "fp-ahmed-baba", name: "Ahmed Baba" },
    curiosity: "Quando os marroquinos o levaram exilado, Ahmed Baba supostamente disse: \"De todos os intelectuais de Tombuctu, eu era o que tinha menos livros. Ainda assim, levaram 1.600 dos meus manuscritos.\"",
    source: "HGA UNESCO, Volume IV"
  },
  {
    id: "w3e8",
    world: 3,
    title: "Antes do Mali, o Gana",
    ...
    hints: [
      "Está na atual Mauritânia.",
      "Foi descrita por al-Bakri em 1067.",
      "Tinha duas cidades — uma islâmica, outra de tradição soninké."
    ],
    fragment: { pattern: "fp-gana-imp", name: "Kumbi Saleh" },
    curiosity: "O Império de Gana caiu por uma combinação de seca, expansão almorávida (1076) e ascensão do Reino de Sosso, que depois cairia para Sundiata em 1235.",
    source: "HGA UNESCO, Volume III"
  },

  /* ============================================================
   * MUNDO 4 — COSTAS E ROTAS (HGA Vol III-IV, séc. I-XVI)
   * ============================================================ */
  {
    id: "w4e1",
    world: 4,
    title: "A Cidade que Cunhava Ouro",
    ...
    hints: [
      ...
      "Hoje é Patrimônio Mundial UNESCO.",
      "Foi destruída por Vasco da Gama em 1505."
    ],
    fragment: { pattern: "fp-kilwa", name: "Kilwa" },
    curiosity: "Ibn Battuta escreveu em 1331: \"Kilwa é uma das mais belas cidades; sua estrutura é elegante e seu povo, religioso e cortês.\" 174 anos depois, Vasco da Gama bombardeou e queimou tudo.",
    source: "HGA UNESCO, Volume IV"
  },
  {
    id: "w4e2",
    world: 4,
    title: "A Pedra Mágica",
    intro: "Sem cimento. Sem cola. Só técnica. Os europeus se recusaram a acreditar.",
    ...
    hints: [
      ...
      "Técnica que exige precisão de encaixe.",
      "As muralhas duram 700 anos sem reparo."
    ],
    fragment: { pattern: "fp-zimbabwe", name: "Grande Zimbabwe" },
    curiosity: "O nome do país atual — Zimbabwe — vem do shona <em>dzimba dzemabwe</em>, \"casas de pedra\". É o único país do mundo nomeado em homenagem a uma ruína africana pré-colonial.",
    source: "HGA UNESCO, Volume IV"
  },
  {
    id: "w4e3",
    world: 4,
    title: "A Língua da Costa",
    ...
    hints: [
      ...
      "Maior família linguística do mundo em número de línguas.",
      "Não é família semítica."
    ],
    fragment: { pattern: "fp-suaili", name: "Kiswahili" },
    curiosity: "Você fala mais suaíli do que pensa: <em>safári</em> (viagem), <em>jambo</em> (olá), <em>hakuna matata</em> (sem problema), <em>simba</em> (leão), <em>rafiki</em> (amigo).",
    source: "HGA UNESCO, Volume IV"
  },
  {
    id: "w4e4",
    world: 4,
    title: "A Ilha das Especiarias",
    ...
    hints: [
      ...
      "Hoje país independente, capital Mascate.",
      "Não é o Iêmen."
    ],
    fragment: { pattern: "fp-zanzibar", name: "Zanzibar" },
    curiosity: "Stone Town em Zanzibar, com suas portas talhadas em madeira nobre, é Patrimônio Mundial UNESCO. Freddie Mercury (Queen) nasceu lá em 1946.",
    source: "HGA UNESCO, Volume IV"
  },
  {
    id: "w4e5",
    world: 4,
    title: "O Mercador de Sofala",
    ...
    hints: [
      ...
      "Atual Zimbabwe e Moçambique.",
      "Sucedeu o Grande Zimbabwe."
    ],
    fragment: { pattern: "fp-sofala", name: "Sofala" },
    curiosity: "Em 1505, os portugueses tomaram Sofala e construíram o <em>Forte de São Caetano</em>, primeira fortaleza europeia da África Oriental. Ainda existe.",
    source: "HGA UNESCO, Volume IV"
  },
  {
    id: "w4e6",
    world: 4,
    title: "O Vento que Comerciava",
    ...
    hints: [
      ...
      "Conhecido sobretudo na Índia.",
      "A palavra vem do árabe \"estação\"."
    ],
    fragment: { pattern: "fp-monsoon", name: "Monção" },
    curiosity: "Os <em>dhows</em> — navios suaílis triangulares de pano — ainda navegam o Índico hoje. Carregam o mesmo tipo de carga que carregavam há mil anos: peixe seco, especiarias, mangas, manteiga.",
    source: "HGA UNESCO, Volume IV"
  },
  {
    id: "w4e7",
    world: 4,
    title: "A Ilha Africana do Sul",
    intro: "Madagáscar não é só ilha. É povo bantu, povo malaio, povo africano misturado.",
    ...
    hints: [
      ...
      "Outra do continente africano.",
      "Genética e linguística confirmam."
    ],
    fragment: { pattern: "fp-madagascar", name: "Madagáscar" },
    curiosity: "É a única região da África onde se cultiva e consome arroz como alimento básico — herança austronésia. A culinária malgaxe é uma fusão de sabores índicos, africanos e asiáticos.",
    source: "HGA UNESCO, Volume IV"
  },
  {
    id: "w4e8",
    world: 4,
    title: "O Bombardeio de Quilwa",
    intro: "Cidade de pedra com mulher de seda. Vasco da Gama destruiu em uma manhã.",
    ...
    hints: [
      ...
      "Francisco de Almeida foi o primeiro vice-rei português da Índia.",
      "Ambos destruíram cidades na costa suaíli em 1502 e 1505."
    ],
    fragment: { pattern: "fp-mombasa", name: "Mombasa" },
    curiosity: "A Fortaleza de Jesus em Mombasa, construída pelos portugueses em 1593, mudou de mãos 9 vezes em 100 anos — entre portugueses, omanitas e britânicos. É Patrimônio Mundial UNESCO.",
    source: "HGA UNESCO, Volume IV"
  },

  /* ============================================================
   * MUNDO 5 — FLORESTAS E REINOS (HGA Vol IV, séc. XII-XVI)
   * ============================================================ */
  {
    id: "w5e1",
    world: 5,
    title: "Os Bronzes Falantes",
    ...
    hints: [
      ...
      "Capital atual Abuja.",
      "A confusão é com o Daomé."
    ],
    fragment: { pattern: "fp-benin", name: "Bronzes do Benin" },
    curiosity: "Os bronzes do Benin foram a primeira evidência irrefutável, para a Europa do final do século XIX, de que a África tinha tradições artísticas sofisticadas anteriores ao contacto colonial. Causaram revolução no campo da história da arte.",
    source: "HGA UNESCO, Volume IV"
  },
  {
    id: "w5e2",
    world: 5,
    title: "O Reino que Escrevia ao Papa",
    ...
    hints: [
      ...
      "Reinou entre 1509 e 1542.",
      "Filho de Nzinga a Nkuwu (João I)."
    ],
    fragment: { pattern: "fp-kongo", name: "Kongo" },
    curiosity: "Henrique, filho de Afonso I, foi enviado a Portugal e tornou-se o <strong>primeiro bispo africano da Igreja Católica</strong>, ordenado em 1518. Voltou ao Kongo em 1521.",
    source: "HGA UNESCO, Volume IV"
  },
  {
    id: "w5e3",
    world: 5,
    title: "Os Adivinhos de Ifé",
    ...
    hints: [
      ...
      "Está na atual Nigéria.",
      "Onde Oduduwa é sepultado, segundo a mitologia."
    ],
    fragment: { pattern: "fp-ife", name: "Ifé" },
    curiosity: "Quando o etnólogo alemão Leo Frobenius encontrou as cabeças de Ifé em 1910, declarou que só poderiam ser obra de \"colonos perdidos da Atlântida\" — incapaz de aceitar autoria africana.",
    source: "HGA UNESCO, Volume IV"
  },
  {
    id: "w5e4",
    world: 5,
    title: "A Rainha-Mãe do Asante",
    ...
    hints: [
      "Asante (atual Gana).",
      "Liderou guerra em 1900.",
      "Morreu no exílio nas Seychelles."
    ],
    fragment: { pattern: "fp-asante", name: "Yaa Asantewaa" },
    curiosity: "O Trono Dourado (Sika Dwa Kofi) — símbolo da alma da nação asante — nunca foi tocado pelos britânicos. Ainda hoje é o objeto sagrado mais importante do reino, oculto a olhares públicos.",
    source: "HGA UNESCO, Volume V"
  },
  {
    id: "w5e5",
    world: 5,
    title: "O Império de Oyo",
    ...
    hints: [
      ...
      "Equivalente africano do checks and balances.",
      "Iorubá: \"sete conselheiros\"."
    ],
    fragment: { pattern: "fp-oyo", name: "Oyo Mesi" },
    curiosity: "A descida ritual da \"cabaça do papagaio\" só foi enviada uma vez no séc. XVIII — para o Alaafin Labisi (1769) — que cumpriu o destino. Pouquíssimos sistemas políticos do mundo tinham mecanismo equivalente.",
    source: "HGA UNESCO, Volume IV"
  },
  {
    id: "w5e6",
    world: 5,
    title: "Os Reinos Lunda e Luba",
    ...
    hints: [
      ...
      "Reino central africano.",
      "Cobre de Katanga."
    ],
    fragment: { pattern: "fp-lunda", name: "Cruzetas de Katanga" },
    curiosity: "A região de Katanga ainda hoje é uma das mais ricas do mundo em cobre e cobalto — minerais essenciais para baterias elétricas. A maldição de recursos do passado continua sendo presente.",
    source: "HGA UNESCO, Volume IV"
  },
  {
    id: "w5e7",
    world: 5,
    title: "A Rainha de Ndongo",
    ...
    hints: [
      "Rainha angolana.",
      "Século XVII.",
      "Resistiu aos portugueses por 30 anos."
    ],
    fragment: { pattern: "fp-nzinga-w5", name: "Nzinga" },
    curiosity: "Em 2022, o Vaticano reconheceu o batismo cristão de Nzinga — gesto que abre caminho para potencial canonização ou beatificação. Seria a primeira santa angolana.",
    source: "HGA UNESCO, Volume V"
  },
  {
    id: "w5e8",
    world: 5,
    title: "A Profeta de São António",
    ...
    hints: [
      "Século XVIII no Kongo.",
      "Movimento antoniano.",
      "Morreu queimada com seu filho."
    ],
    fragment: { pattern: "fp-floresta", name: "Kimpa Vita" },
    curiosity: "Kimpa Vita é considerada uma das primeiras teólogas africanas e proto-feministas do continente. O processo inquisitorial que a executou é hoje considerado caso emblemático da violência religiosa colonial.",
    source: "HGA UNESCO, Volume V"
  },

  /* ============================================================
   * MUNDO 6 — RESISTÊNCIA (HGA Vol V-VI, séc. XV-XIX)
   * ============================================================ */
  {
    id: "w6e1",
    world: 6,
    title: "A República Negra",
    intro: "Cem anos. Vinte mil pessoas. Um quilombo que era reino.",
    context: "O <strong>Quilombo dos Palmares</strong> (1605-1694), na Serra da Barriga (Alagoas), foi o maior quilombo das Américas. Chegou a abrigar 20.000 pessoas em vários mocambos federados sob um Mocambo Macaco. Resistiu por 89 anos a expedições portuguesas e bandeirantes paulistas, antes de cair com a morte de Zumbi em 1695.",
    question: "Em que serra brasileira ficava o Quilombo dos Palmares?",
    options: ["Serra da Barriga (Alagoas)", "Serra do Mar (SP)", "Serra dos Órgãos (RJ)", "Serra Geral (SC)"],
    correct: 0,
    explanation: "A Serra da Barriga, em União dos Palmares (AL), oferecia defesa natural — penhascos, mata fechada e nascentes. Hoje é Patrimônio Cultural Brasileiro e sítio arqueológico em estudo contínuo.",
    hints: [
      "Estado da região nordeste.",
      "Capital Maceió.",
      "Banhada pelo Rio São Francisco."
    ],
    fragment: { pattern: "fp-palmares", name: "Palmares" },
    curiosity: "Em 2007, a Universidade de Pernambuco e o IPHAN começaram escavações arqueológicas em Palmares. Encontraram cerâmicas, ferramentas de ferro, sementes — confirmando complexidade econômica e agrícola muito além do esperado.",
    source: "HGA UNESCO, Volume V"
  },
  {
    id: "w6e2",
    world: 6,
    title: "O Rei que Não Caiu na Batalha",
    ...
    fragment: { pattern: "fp-zumbi", name: "Zumbi" },
    curiosity: "Em 1995, no tricentenário da morte de Zumbi, o presidente FHC reconheceu oficialmente sua importância histórica. Em 2011, Dilma sancionou o feriado nacional. Zumbi virou símbolo central do movimento negro brasileiro.",
    source: "HGA UNESCO, Volume V"
  },
  {
    id: "w6e3",
    world: 6,
    title: "A Companheira que Pulou",
    ...
    hints: [
      ...
      "Pulou do penhasco antes de ser capturada."
    ],
    fragment: { pattern: "fp-dandara", name: "Dandara" },
    curiosity: "O nome Dandara virou símbolo central do feminismo negro brasileiro. Há ruas, escolas, prêmios e ONGs com seu nome. O Brasil só teve heroína oficial reconhecida em 2019, quando Dandara foi inscrita no Livro dos Heróis e Heroínas da Pátria.",
    source: "HGA UNESCO, Volume V"
  },
  {
    id: "w6e4",
    world: 6,
    title: "A Avó dos Quilombolas",
    ...
    hints: [
      "Veio do Kongo.",
      "Avó de Zumbi.",
      "Capturada após batalha em África."
    ],
    fragment: { pattern: "fp-aqualtune", name: "Aqualtune" },
    curiosity: "Aqualtune entrou no Livro dos Heróis e Heroínas da Pátria em 2019, junto com Dandara, Luiza Mahin e outras 15 mulheres negras. Foi uma reparação simbólica de quase 4 séculos.",
    source: "HGA UNESCO, Volume V"
  },
  {
    id: "w6e5",
    world: 6,
    title: "O Haiti que Derrotou Napoleão",
    ...
    fragment: { pattern: "fp-haiti", name: "Haiti" },
    curiosity: "Em 2003, o Haiti exigiu de Paris a devolução dos 21 bilhões de dólares (em valores atuais) que pagou à França entre 1825 e 1947 como \"indenização\" pela independência. A França se recusa.",
    source: "HGA UNESCO, Volume V"
  },
  {
    id: "w6e6",
    world: 6,
    title: "A Capitã do Quariterê",
    ...
    hints: [
      ...
      "Século XVIII.",
      "Sua data de morte virou Dia Nacional da Mulher Negra."
    ],
    fragment: { pattern: "fp-tereza", name: "Tereza de Benguela" },
    curiosity: "O nome \"de Benguela\" indica que Tereza ou seus pais foram capturados em Benguela, Angola. Cerca de 40% dos africanos escravizados no Brasil vieram de portos angolanos.",
    source: "HGA UNESCO, Volume V"
  },
  {
    id: "w6e7",
    world: 6,
    title: "A Líder Cubana",
    ...
    hints: [
      ...
      "Capital Havana.",
      "A Operação Carlota foi a intervenção cubana em Angola."
    ],
    fragment: { pattern: "fp-yaa", name: "Carlota Lucumí" },
    curiosity: "A Operação Carlota (1975-1991) levou cerca de 380 mil cubanos a Angola para apoiar o MPLA na luta contra invasão sul-africana. O nome foi escolhido pessoalmente por Fidel Castro como tributo.",
    source: "HGA UNESCO, Volume V"
  },
  {
    id: "w6e8",
    world: 6,
    title: "A Ousada de Salvador",
    ...
    hints: [
      "Salvador, 1835.",
      "Liderada por africanos islâmicos.",
      "\"Malê\" vem do iorubá para \"muçulmano\"."
    ],
    fragment: { pattern: "fp-toussaint", name: "Malês" },
    curiosity: "Após a Revolta dos Malês, o governo imperial baniu ler/escrever em árabe e criou registros policiais específicos para \"africanos perigosos\". É um dos primeiros casos de perfilamento racial sistemático na história brasileira.",
    source: "HGA UNESCO, Volume V"
  },

  /* ============================================================
   * MUNDO 7 — O ENCONTRO FORÇADO (HGA Vol V-VI, séc. XV-XIX)
   * ============================================================ */
  {
    id: "w7e1",
    world: 7,
    title: "Os Orixás Disfarçados de Santos",
    ...
    fragment: { pattern: "fp-candomble", name: "Candomblé" },
    curiosity: "Mãe Aninha disse: \"Religião não tem cor.\" Mas guardou em segredo cantos em iorubá durante décadas em que o Candomblé era criminalizado. Foi presa várias vezes — sempre solta por pressão social e política.",
    source: "HGA UNESCO, Volume VI"
  },
  {
    id: "w7e2",
    world: 7,
    title: "A Dança que Era Luta",
    ...
    hints: [
      ...
      "Inventou a capoeira regional.",
      "Fundou primeira academia de capoeira do mundo."
    ],
    fragment: { pattern: "fp-capoeira", name: "Capoeira" },
    curiosity: "Antes de 1890, praticar capoeira no Brasil era crime previsto no Código Penal: 6 meses a 2 anos de prisão. Quem era pego com berimbau podia ser preso. A descriminalização efetiva só aconteceu em 1937, quando Mestre Bimba demonstrou pessoalmente para o presidente Getúlio Vargas.",
    source: "HGA UNESCO, Volume VI"
  },
  {
    id: "w7e3",
    world: 7,
    title: "O Samba Que Veio do Lundu",
    ...
    hints: [
      ...
      "Não é iorubá.",
      "Origem majoritária dos escravizados no Brasil."
    ],
    fragment: { pattern: "fp-samba", name: "Samba" },
    curiosity: "Pelo Telefone (1917) virou \"primeiro samba gravado\" mas tia Ciata, em cuja casa se reuniam Donga, Pixinguinha e João da Baiana, é considerada a verdadeira matriz do samba urbano. Mulher negra, mãe-de-santo, esquecida pelos créditos oficiais.",
    source: "HGA UNESCO, Volume VI"
  },
  {
    id: "w7e4",
    world: 7,
    title: "O Terreiro Como Escola",
    intro: "Onde se ensinava o que a escola colonial proibia: a língua, o orixá, o saber.",
    context: "Os <strong>terreiros de candomblé</strong> funcionaram como espaços de preservação linguística (iorubá ritual), médica (uso de ervas), psicológica (acolhimento) e social (mutirão econômico) para comunidades negras. Eram \"escolas paralelas\" durante toda a era da escravidão e além. Hoje vários terreiros são reconhecidos como Patrimônio Cultural Brasileiro.",
    ...
    hints: [
      ...
      "Preservação linguística e médica."
    ],
    fragment: { pattern: "fp-terreiro", name: "Terreiro" },
    curiosity: "Em 1986, o Terreiro Casa Branca em Salvador foi o primeiro tombado como Patrimônio Histórico pelo IPHAN. Foi ato político — reconheceu finalmente o Candomblé como cultura brasileira oficial.",
    source: "HGA UNESCO, Volume VI"
  },
  {
    id: "w7e5",
    world: 7,
    title: "As Palavras que Falamos",
    ...
    hints: [
      ...
      "Predominante em Angola e Moçambique.",
      "Maior família linguística do mundo."
    ],
    fragment: { pattern: "fp-orixa", name: "Africanismos" },
    curiosity: "A palavra \"bunda\" — uma das mais usadas — é quimbundo. <em>mbunda</em> em angolano significa \"nádega\". Outra palavra surpreendente: <em>marimbondo</em> (vespa) também é quimbundo.",
    source: "HGA UNESCO, Volume VI"
  },
  {
    id: "w7e6",
    world: 7,
    title: "A Cozinha que Africanizou",
    ...
    hints: [
      ...
      "Década de 2000.",
      "Antes da Lei de Cotas (2012)."
    ],
    fragment: { pattern: "fp-vatapa", name: "Acarajé" },
    curiosity: "Vender acarajé tradicionalmente é função de mulheres negras chamadas \"baianas de acarajé\". É a única atividade comercial reconhecida como expressão cultural protegida pelo IPHAN — não pode ser proibida nem regulamentada como comércio comum.",
    source: "HGA UNESCO, Volume VI"
  },
  {
    id: "w7e7",
    world: 7,
    title: "O Jongo da Vovó",
    ...
    hints: [
      "Sudeste do Brasil.",
      "Região do café no séc. XIX.",
      "Não é Bahia."
    ],
    fragment: { pattern: "fp-jongo", name: "Jongo" },
    curiosity: "O ponto de jongo \"Lê lê lê\" cantado por crianças em escolas modernas é, originalmente, charada cifrada para alertar quilombolas sobre patrulhas de capitães-do-mato. Linguagem secreta como sobrevivência.",
    source: "HGA UNESCO, Volume VI"
  },
  {
    id: "w7e8",
    world: 7,
    title: "O Pai do Choro",
    ...
    hints: [
      "Flautista virtuose.",
      "Compôs Carinhoso.",
      "Excursionou pela Europa em 1922."
    ],
    fragment: { pattern: "fp-pixinguinha", name: "Pixinguinha" },
    curiosity: "Pixinguinha enfrentou racismo até o fim da vida. Em 1922, quando Os Oito Batutas tocaram em Paris, jornais brasileiros conservadores reclamaram que aquilo \"manchava a imagem do Brasil\". Hoje o Dia Nacional do Choro (23 de abril) é seu aniversário.",
    source: "HGA UNESCO, Volume VI"
  },

  /* ============================================================
   * MUNDO 8 — LUTA E LIBERDADE (HGA Vol VII-VIII, séc. XIX-XXI)
   * ============================================================ */
  {
    id: "w8e1",
    world: 8,
    title: "A Conferência da Mesa",
    ...
    hints: [
      ...
      "Outro foi fundado por afrodescendentes americanos.",
      "Ambos no leste e oeste africanos."
    ],
    fragment: { pattern: "fp-au", name: "Berlim 1885" },
    curiosity: "A Etiópia é também o único país do mundo a nunca ter sido colonizado, exceto pela ocupação italiana de 5 anos (1936-1941) sob Mussolini — que terminou com vitória etíope na 2ª Guerra Mundial.",
    source: "HGA UNESCO, Volume VII"
  },
  {
    id: "w8e2",
    world: 8,
    title: "O Ladrão do Imperador",
    ...
    hints: [
      ...
      "Maior país da África subsaariana em área.",
      "Capital Kinshasa."
    ],
    fragment: { pattern: "fp-lumumba", name: "Lumumba" },
    curiosity: "Em 2002, o governo belga reconheceu \"responsabilidade moral\" no assassinato. Em 2022, o Rei Filipe da Bélgica entregou pessoalmente o que restou do corpo de Lumumba (um dente preservado por agente belga) à filha Juliana Lumumba.",
    source: "HGA UNESCO, Volume VIII"
  },
  {
    id: "w8e3",
    world: 8,
    title: "A Libertação da Mente",
    ...
    hints: [
      "Capital Conakry.",
      "Primeiro país francófono da África a ser independente (1958).",
      "Não confundir com Guiné-Bissau."
    ],
    fragment: { pattern: "fp-cabral", name: "Amílcar Cabral" },
    curiosity: "O irmão de Amílcar — Luís Cabral — tornou-se o primeiro presidente da Guiné-Bissau independente em 1974. Cumpriu o sonho de Amílcar, mas governou apenas 6 anos antes de ser deposto.",
    source: "HGA UNESCO, Volume VIII"
  },
  {
    id: "w8e4",
    world: 8,
    title: "A Estrela de Ouro",
    ...
    hints: [
      "Década de 1950.",
      "Antes do Ano da África (1960).",
      "Ímpar."
    ],
    fragment: { pattern: "fp-nkrumah", name: "Nkrumah" },
    curiosity: "Nkrumah cunhou o lema \"<em>Forward Ever, Backward Never</em>\" — ainda lema oficial de Gana. Foi deposto por golpe militar (com apoio CIA) em 1966. Morreu em exílio na Romênia em 1972.",
    source: "HGA UNESCO, Volume VIII"
  },
  {
    id: "w8e5",
    world: 8,
    title: "O Médico Soldado",
    ...
    fragment: { pattern: "fp-neto", name: "Neto" },
    curiosity: "O hino nacional de Angola — <em>Angola Avante</em> — usa versos de Neto. Em 1979, na sua morte, Angola entrou em luto continental. Hoje, o aeroporto de Luanda leva seu nome.",
    source: "HGA UNESCO, Volume VIII"
  },
  {
    id: "w8e6",
    world: 8,
    title: "A Consciência Negra",
    ...
    hints: [
      "País do apartheid.",
      "Capital Pretória.",
      "Mandela esteve preso lá."
    ],
    fragment: { pattern: "fp-biko", name: "Steve Biko" },
    curiosity: "Em 1997, durante a Comissão da Verdade e Reconciliação sul-africana, os 5 policiais que torturaram Biko foram identificados. Mas todos receberam anistia em troca de confissão pública. Justiça restaurativa, controversa até hoje.",
    source: "HGA UNESCO, Volume VIII"
  },
  {
    id: "w8e7",
    world: 8,
    title: "27 Anos de Pedra",
    ...
    hints: [
      "Mais de 25 anos.",
      "Menos de 30.",
      "Quase a metade da expectativa de vida."
    ],
    fragment: { pattern: "fp-mandela", name: "Mandela" },
    curiosity: "Mandela disse: \"Não há nada mais difícil que perdoar. Mas não há nada mais necessário também.\" Sua escolha pela reconciliação em vez de vingança evitou guerra civil sul-africana após 1994 — referência mundial em transição política.",
    source: "HGA UNESCO, Volume VIII"
  },
  {
    id: "w8e8",
    ...
    fragment: { pattern: "fp-pan", name: "Agenda 2063" },
    curiosity: "Em 2024, a União Africana foi formalmente convidada a integrar o G20 — virou \"AU+G20\" ou \"G21\". Foi a primeira inclusão de uma organização continental como membro pleno do G20.",
    source: "HGA UNESCO, Volume VIII"
  }
];
